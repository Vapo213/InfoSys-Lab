...
ALTER TABLE VERANSTALTUNG ADD
  ( CONSTRAINT checkConstraint CHECK (Zeichen IN {'L','V'}) );
...
CREATE TABLE ZUORDNUNG_VERANSTALTUNG_DOZENT
	( ZUORDNUNG_VERANSTALTUNG_DOZENT_ID int NOT NULL
...
ALTER TABLE VERANSTALTUNG
	ADD CONSTRAINT VERANSTALTUNG_MODUL FOREIGN KEY
	( MODUL_ID )
	REFERENCES MODUL
	( MODUL_ID ); 
